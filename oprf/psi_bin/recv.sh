#     0:send,1:recv  
time ./psi -r 1 -w 128 -h 20 -ss 10000000  -rs 10000000 -sd 20 -ids 21 -omp 4
# time ./psi -r 1 -w 128 -h 20 -ss 50000000  -rs 50000000 -sd 210 -ids 21 -ip 172.16.48.172 -omp 4
