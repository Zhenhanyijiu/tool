...
######psi#
nohup python3 psi3_process.py --m=100000 --p=0 >/dev/null 2>&1 &
nohup python3 psi3_process.py --m=100000 --p=1 >/dev/null 2>&1 &
time python3 psi3_process.py --m=100000 --p=2